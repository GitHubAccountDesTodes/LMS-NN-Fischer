...
public class MainFrame extends JFrame {
	...
	public void calculateLeastSquaresOptimum() {
		/**
		 * Diese Methode berechnet das least Squares Optimum bisher nur für das
		 * Output Neuron. Für die Hidden Neuronen wird noch nichts berechnet.
		 */
		...
		for (int y = 0; y < imageHeight; y += 1) {
			for (int x = 0; x < imageWidth; x += 1) {
				...
				if (color > 255)
					color = 255;
				if (border) {
					inputOutput.drawPixel(x, y, new Color(255, 255, 255));
				} else {
